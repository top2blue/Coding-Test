...
public class Ex01 {
	public static void main(String[] args) {
		/*
		 * 이 문제는 스택 자료구조로 해결할 수 있다. 
		 * 레이저를 만나면 그 전까지 쌓인 막대기들이 잘리기 때문에, 
		 * 그 전까지 쌓인 막대기들의 개수를 알면 잘린 토막의 개수를 알 수 있다.
		 * 위와 같이 하면 "))"일때는 카운트를 하지 않기 때문에 조건을 주어 이전이 ")" 이면 개수 증가
		 */
		String arrangement = "()(((()())(())()))(())";
		int answer = 0;
		...
		System.out.println("막대개수 : " + answer);
	}
	@Test
	public void test() {
