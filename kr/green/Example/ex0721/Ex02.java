...
public class Ex02 {
	...
	public void test() {
		...
		assertArrayEquals(solution.solution(new int[] {6,9,5,7,4}), new int[] {0,0,2,2,4});
		assertArrayEquals(solution.solution(new int[] {3,9,9,3,5,7,2}), new int[] {0,0,0,3,3,3,6});
		assertArrayEquals(solution.solution(new int[] {1,5,3,6,7,6,5}), new int[] {0,0,2,0,0,5,6});
	}
	class Solution {
