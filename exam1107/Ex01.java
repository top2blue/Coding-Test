...
public class Ex01 {
	public static void main(String[] args) {
		System.out.println(checkCol("lazy", "crossword"));
		System.out.println(checkRow("lazy", "crossword"));
		System.out.println(checkCol("crossword", "boolean"));
		System.out.println(checkRow("crossword", "boolean"));
		makeCrossword("lazy", "crossword");
		makeCrossword("crossword", "boolean");
		makeCrossword("string", "str");
