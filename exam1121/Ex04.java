...
public class Ex04 {
	...
	public void test1() {
		...
		assertEquals(solution.solution(10), true);
		assertEquals(solution.solution(12), true);
		assertEquals(solution.solution(11), false);
		assertEquals(solution.solution(13), false);
	}
